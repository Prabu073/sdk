...
1. Use Java 11 and add `zohoflow-onprem-extension-sdk.jar` and `json.jar` to the compile classpath — see [SDK dependency](../README.md#sdk-dependency) for Maven coordinates and download options.
